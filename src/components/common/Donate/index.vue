...
<template>
  <NModal v-model:show="show" :auto-focus="false">
    <NCard role="dialog" aria-modal="true" :bordered="false" preset="dialog" title="感谢支持！" style="width: 95%; max-width: 90%;height: 95%; max-height: 90%" close-on-esc closable @close="handleClose">
